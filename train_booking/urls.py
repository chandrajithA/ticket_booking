...
app_name = 'train_booking'

urlpatterns = [
    path('', train_display, name='train_display'),   
    path('search/', filter_trains, name='filter_trains'),
    path('class-selection/<int:trip_id>/', class_selection, name = 'class_selection'),
